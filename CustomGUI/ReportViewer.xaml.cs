...
namespace SARGUI.CustomGUI
{
    public partial class ReportViewer : FormView, INotifyPropertyChanged
    {
        ...
        public static partial Boolean SetDefaultPrinter(String name);
        public event PropertyChangedEventHandler? PropertyChanged;

        #region PageTrackerProperty
        public static readonly DependencyProperty PageTrackerProperty
        = View.Binder.Register<string, ReportViewer>(nameof(PageTracker), true, "No Pages", null, true, true, true);
        ...
        public ReportViewer(List<IPageReport> pages)
        {
            ...
            SetDefaultPrinter(PrinterManager.DefaultPrinter);
            PrinterComboBox.ItemsSource = PrinterManager.AllPrinters();
            PrinterComboBox.SelectedItem = PrinterManager.DefaultPrinter;
            ...
            View.Binder.BindUp(this, nameof(PageTracker), PageTrackerLabel, Label.ContentProperty);
    ...
    {
        readonly ListOfPages PagesSource;
        Size _size = new();
    ...
    public class ReportMainGrid : Grid
    {
        ...
        = View.Binder.Register<GridLength, ReportMainGrid>(nameof(HeaderHeight), true, new(100), null, true, true, true);
        ...
        = View.Binder.Register<GridLength, ReportMainGrid>(nameof(FooterHeight), true, new(50), null, true, true, true);
        ...
        public ReportMainGrid()
        {
            ...
            View.Binder.BindUp(this, nameof(FooterHeight), RowFooter, RowDefinition.HeightProperty);
        }
    ...
    {
        readonly List<Map> RemovedElements = new();
        ...
        public bool BreakPage()
        {
            ...
            foreach (UIElement child in MainBody.Children.Cast<UIElement>().ToList())
            {
                ...
                Label? childLabel = (child is Label label) ? label : null;
    ...
    public class ReportFooter : ReportBorder
    {
        ...
        = View.Binder.Register<string, ReportFooter>(nameof(PageNumberStringFormat), true, "Page: {0}", null, true, true, true);
        ...
        = View.Binder.Register<int, ReportFooter>(nameof(PageNumber), true, 1, null, true, true, true);
    ...
    public class PageReport : ReportMainGrid, IPageReport
    {
            ...
            foreach (var x in ReportComponents)
            {
                switch (x)
                {
                    ...
                    case ReportFooter:
                        ...
                        View.Binder.BindUp(this, nameof(PageNumber), Footer, ReportFooter.PageNumberProperty);
                        break;
                }
                Children.Add(x);
            }
        ...
        #region PageNumberProperty
        public static readonly DependencyProperty PageNumberProperty
        = View.Binder.Register<int, PageReport>(nameof(PageNumber), true, 1, null, true, true, true);
    ...
    public class XAMLCloner
    {
        public static T NewInstanceOf<T>(T obj)
        {
            ...
            return instance == null ? throw new Exception($"Something went wrong when creating a New Instance of {t}") : (T)instance!;
        }

        public static T Copy<T>(object obj)
        {
            string savedObject = XamlWriter.Save(obj);
            StringReader stringReader = new(savedObject);
    ...
    public class ListString : List<string>
    {
        ...
        readonly List<string> RemovedStrings = new();
        ...
        static Size MeasureString(Label? label)
        {
            ...
            Size size = new(formattedText.Width, formattedText.Height);
